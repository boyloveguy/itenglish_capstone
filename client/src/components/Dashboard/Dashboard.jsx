...
class Dashboard extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>ITEnglish | Dashboard</title>
        </Helmet>
        <div>
        ...
        <Container className="pad-bot-10">
          ...
          <Row className="pad-top-50">
            ...
            <Col sm={5} className="pad-top-100">
              ...
              <p>
                <i className="map marker alternate icon"></i>254 Nguyen Van
                Linh, Da Nang, Viet Nam
              </p>
              <p>
                <i className="phone icon"></i>(+84) 0123456789
              </p>
              <p>
                <i className="envelope icon"></i>itenglish@gmail.com
              </p>
            </Col>
          </Row>
          <hr
