                            ...
                            <Row>
                                <Col sm={5}>
                                    <Carousel.Caption>
                                        ...
                                        <h3>Exchange experiences with the IT community in English.</h3>
                                    </Carousel.Caption>
                                </Col>
                                <Col sm={7}></Col>
                            </Row>
                            ...
                            <Row>
                                <Col sm={5}>
                                    <Carousel.Caption>
                                        ...
                                        <h3>Help you expand your specialized vocabulary knowledge through fun and practical tests.</h3>
                                    </Carousel.Caption>
                                </Col>
                                <Col sm={7}></Col>
                            </Row>
                            ...
                            <Row>
                                <Col sm={5}>
                                    <Carousel.Caption>
                                        ...
                                        <h3>Challenge yourself every day through ITEnglish will help you develop yourself.</h3>
                                    </Carousel.Caption>
                                </Col>
                                <Col sm={7}></Col>
                            </Row>
                ...
                <Container className='pad-top-50'>
                    <Row>
                        ...
                        <Col sm={7} className='pad-top-50'>
                            ...
                            <h4>You can learn all the vocabulary used in your major, imporving your understanding and in-depth vocabulary. We also provide the function of contributing new words from users to improve the richer vocabulary.</h4>
                            <p>Vocabulary plays an important part in learning to read. Beginning readers must use the words they hear orally to make sense of the words they see in print.</p>
                            <Button variant="outline-secondary" className='btn-go'>Go</Button>
                        </Col>
                    </Row>
                </Container>
                <Container className='pad-top-50'>
                    <Row>                        
                        <Col sm={7} className='pad-top-50'>
                            ...
                            <p>Most online teaching opportunities provide work as an independent contractor. What this means is that there are no set hours and you can work as much or as little as you wish. Of course, that's also the catch—often there is little work to be had.</p>
                            <Button variant="outline-secondary" className='btn-go'>Go</Button>
                        </Col>
                        <Col sm={5}>
                            <img
                ...
                <Container className='pad-top-50'>
                    <Row>
                        ...
                        <Col sm={7} className='pad-top-50'>
                            ...
                            <h4>You can also join a video call with a strangers. People can talk to each other about their major of study, works, companies... related to IT or whatever they like in English.</h4>
                            <p>Learn by Chatting! The best way to learn a language is to actually speak it! ITEnglish connects you with IT speakers to chat with for free.</p>
                            <Button variant="outline-secondary" className='btn-go'>Go</Button>
                        </Col>
                    </Row>
                </Container>
                <Container className='pad-top-50 pad-bot-50'>
                    <Row>                        
                        <Col sm={7} className='pad-top-50'>
                            ...
                            <p>This online level test will give you an approximate indication of your English proficiency level. You can use the result to help you find content on our website that is appropriate for your English language ability.</p>
                            <Button variant="outline-secondary" className='btn-go'>Go</Button>
                        </Col>
                        <Col sm={5}>
                            <img
