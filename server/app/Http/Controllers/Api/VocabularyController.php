...
class VocabularyController extends Controller
{
    function get_vocabulary(Request $res){
        try {
            ...
            ->leftJoin('vocabulary_speech', 'vocabulary_speech.voc_id', '=', 'vocabulary.voc_id')
            ->leftJoin('parts_of_speech', 'vocabulary_speech.pos_id', '=', 'parts_of_speech.pos_id')
    ...
    function delete_vocabulary(Request $res){
        try {
            ...
            VocabularySpeech::where('voc_id', '=', $voc_id)->delete();
            VocabularyITType::where('voc_id', '=', $voc_id)->delete();
            VocabularyMeaning::where('voc_id', '=', $voc_id)->delete();
            VocabularyExample::where('voc_id', '=', $voc_id)->delete();
