            ...
            Swal.fire({
                ...
                if (results.isConfirmed) {
                    if (validate) {
                        ...
                        const url = 'http://localhost:8080/itenglish_capstone/server/public/api/save_vocabulary';
                        axios({
                            method: 'POST',
                            url: url,
                            dataType: 'jsonp',
        ...
        try {
            Swal.fire({
                ...
                if (results.isConfirmed) {
                        ...
                        const url = 'http://localhost:8080/itenglish_capstone/server/public/api/delete_vocabulary';
                        axios({
                            method: 'POST',
                            url: url,
                            dataType: 'jsonp',
